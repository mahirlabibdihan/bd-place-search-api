...
module.exports = {
  ...
  NOMINATIM_DATABASE: process.env.NOMINATIM_DATABASE || "nominatim",
  PSQL_BIN: process.env.PSQL_BIN || "/usr/bin/psql",
  NOMINATIM_STATUS_DSN: process.env.NOMINATIM_STATUS_DSN || "postgresql://place_search_status@127.0.0.1:5432/nominatim",
  NOMINATIM_STATUS_PGPASSFILE: process.env.NOMINATIM_STATUS_PGPASSFILE || "/srv/place-search/.pgpass",
